...
def MM_AE_retraining(model, model_folder_path, RNA_df_path, miRNA_df_path, hyper_dict):
...
if __name__ == '__main__':
    ...
    for group in [2, 3, 4, 5]:
        for prop_diff in [0.2, 0.4, 0.6, 0.8, 1]:
            ...
            hyper_dict = {}
            with open(f'/home/wangc90/Data_integration/simulation_model_outputs/model_selection_outputs/MM_AE/optuna/optuna_{group}_groups_{prop_diff}/optuna.txt') as f:
                for _ in range(7):
                    next(f)
                for line in f:
            ...
            class MM_AE_Encoder(nn.Module):
                ...
                def __init__(self):
                    ...
                    self.l2_s21_out_dim = hyper_dict['l2_s21_out_dim']

                    self.l3_ss_out_dim = hyper_dict['l3_ss_out_dim']
                    ...
                    l2_s21_drop_rate = hyper_dict['l2_s21_drop_rate']
                    ...
                    l3_ss_drop_rate = hyper_dict['l3_ss_drop_rate']
                    ...
                    embed_ss_drop_rate = hyper_dict['embed_ss_drop_rate']
            ...
            model_folder_path = f'/home/wangc90/Data_integration/simulation_model_outputs/model_retraining_outputs/MM_AE/models/retrained_{group}_groups_{prop_diff}_diff'
            if not os.path.exists(model_folder_path):
                print('Create folder to store retrained models')
                os.makedirs(model_folder_path)

            MM_AE_retraining(model=MM_AE,
