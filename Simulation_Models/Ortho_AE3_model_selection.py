...
def CustomLoss(s1, s2, s1_out, s2_out,
    ...
    z12_t_z1_diag_square_sum = torch.sum(
        torch.square(z12_t_z1_diag))  ## get squared term to make it close to 0 in magnitude
...
def Ortho_AE3_model_selection(num_trial, val_loss_folder_path, optuna_folder_path, RNA_df_path, miRNA_df_path):
...
if __name__ == '__main__':
    ...
    for group in [2, 3, 4, 5]:
        for prop_diff in [0.2, 0.4, 0.6, 0.8, 1]:
            ...
            val_loss_folder_path = f'/home/wangc90/Data_integration/simulation_model_outputs/model_selection_outputs/Ortho_AE3/val_loss/val_{group}_groups_{prop_diff}_loss'
            optuna_folder_path = f'/home/wangc90/Data_integration/simulation_model_outputs/model_selection_outputs/Ortho_AE3/optuna/optuna_{group}_groups_{prop_diff}'
            ...
            Ortho_AE3_model_selection(num_trial=50, val_loss_folder_path=val_loss_folder_path,
